# Skills Candidates — from Claude-Code-Projects-Index

Source: [Claude-Code-Projects-Index/analysis/skills-candidates.md](https://github.com/danielrosehill/Claude-Code-Projects-Index/blob/main/analysis/skills-candidates.md) — imported as the authoritative classification for repos in that index.
