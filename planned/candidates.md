...
## Additional Candidates from Personal Repo Scan

Repos present on github.com/danielrosehill but **not** listed in [Claude-Code-Projects-Index](https://github.com/danielrosehill/Claude-Code-Projects-Index) that look like viable skill sources. Curated from a 402-repo filtered set — not exhaustive; full diff in `/tmp/missing.txt` during scan.

### Agent / AI infra
- [AI-Agent-Ideation-Agent](https://github.com/danielrosehill/AI-Agent-Ideation-Agent) — skill for ideating new agents
- [AI-Assistant-Ideator](https://github.com/danielrosehill/AI-Assistant-Ideator)
- [AI-Harnesses](https://github.com/danielrosehill/AI-Harnesses) — harness comparison/selection
- [AI-Model-Manager](https://github.com/danielrosehill/AI-Model-Manager)
- [AI-Repo-Manager](https://github.com/danielrosehill/AI-Repo-Manager)
- [Agent-Handover-Demo](https://github.com/danielrosehill/Agent-Handover-Demo) — feeds handover skill
...
- [Claude-Agents](https://github.com/danielrosehill/Claude-Agents)
- [Claude-Code-Repo-Manager](https://github.com/danielrosehill/Claude-Code-Repo-Manager)
- [Claude-Explorer](https://github.com/danielrosehill/Claude-Explorer)
- [Claude-Tooling](https://github.com/danielrosehill/Claude-Tooling)

### MCP-related
- [BTRFS-Snapper-MCP](https://github.com/danielrosehill/BTRFS-Snapper-MCP)
- [CheckID-MCP](https://github.com/danielrosehill/CheckID-MCP)
- [Cloud-ASR-MCP](https://github.com/danielrosehill/Cloud-ASR-MCP)
- [Cloudflare-MCP](https://github.com/danielrosehill/Cloudflare-MCP)
- [Desktop-MCP](https://github.com/danielrosehill/Desktop-MCP) / [Desktop-Meta-MCP](https://github.com/danielrosehill/Desktop-Meta-MCP) / [Home-Desktop-MCP](https://github.com/danielrosehill/Home-Desktop-MCP)
- [Dynamic-MCP-Proxy](https://github.com/danielrosehill/Dynamic-MCP-Proxy)
- [Fal-Nano-MCP](https://github.com/danielrosehill/Fal-Nano-MCP)
...
- [Green-Invoice-MCP](https://github.com/danielrosehill/Green-Invoice-MCP) — feeds the templated billing email skill
- [HA-MCP-0825](https://github.com/danielrosehill/HA-MCP-0825)
- [Home-MCP-Manager-0126](https://github.com/danielrosehill/Home-MCP-Manager-0126)
- [K3B-MCP](https://github.com/danielrosehill/K3B-MCP) — optical burn skill
- [Kilo-MCP-Manager](https://github.com/danielrosehill/Kilo-MCP-Manager)
- [LAN-MCP-Aggregated](https://github.com/danielrosehill/LAN-MCP-Aggregated) / [LAN-MCP-Deploy](https://github.com/danielrosehill/LAN-MCP-Deploy)
- [Local-AI-Transcription-MCP](https://github.com/danielrosehill/Local-AI-Transcription-MCP)

### DSR Holdings / Carrot Cake AI
- [Carrot-Cake-AI-Ops](https://github.com/danielrosehill/Carrot-Cake-AI-Ops)
- [Carrot-Cake-AI-Orchestrator](https://github.com/danielrosehill/Carrot-Cake-AI-Orchestrator)
- [Carrot-Cake-AI-Pipeline](https://github.com/danielrosehill/Carrot-Cake-AI-Pipeline)
- [Carrot-Cake-AI-Pricing-And-Research](https://github.com/danielrosehill/Carrot-Cake-AI-Pricing-And-Research)
- [Carrot-Cake-AI-Site](https://github.com/danielrosehill/Carrot-Cake-AI-Site)
- [DSR-Holdings-AI-Stack](https://github.com/danielrosehill/DSR-Holdings-AI-Stack)

### Research / Domain
- [AI-Research-Gathering](https://github.com/danielrosehill/AI-Research-Gathering)
...
- [Digestive-Problems-Agent](https://github.com/danielrosehill/Digestive-Problems-Agent)
- [Friendly-AI-Exploration-Bot](https://github.com/danielrosehill/Friendly-AI-Exploration-Bot)
- [HIW-Blog-Manager-Agent](https://github.com/danielrosehill/HIW-Blog-Manager-Agent)
- [Israel-Preparedness-Guidelines-AI-Assistant](https://github.com/danielrosehill/Israel-Preparedness-Guidelines-AI-Assistant)
- [JLM-Shelter-Agent](https://github.com/danielrosehill/JLM-Shelter-Agent)
- [LLM-Detective](https://github.com/danielrosehill/LLM-Detective)
- [LLM-Recommendation-Agent](https://github.com/danielrosehill/LLM-Recommendation-Agent)

### Media / Workflow
- [AI-Fix-My-Messy-Whiteboard](https://github.com/danielrosehill/AI-Fix-My-Messy-Whiteboard) — whiteboard cleanup skill
- [AI-Transcription-Notepad](https://github.com/danielrosehill/AI-Transcription-Notepad)
- [AI-Timesheet-Creator](https://github.com/danielrosehill/AI-Timesheet-Creator)
- [AI-Video-Workspace](https://github.com/danielrosehill/AI-Video-Workspace)
- [Ai-Media-Monitor](https://github.com/danielrosehill/Ai-Media-Monitor)
- [Claude-Spam-Processor](https://github.com/danielrosehill/Claude-Spam-Processor)

> Full 402-entry filtered list and 1,837-entry raw diff are not committed — rerun the scan script with `gh repo list danielrosehill --limit 2000` + the indexed-names comm diff to regenerate.
